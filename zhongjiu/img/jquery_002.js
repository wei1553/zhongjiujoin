        ...
        var that = $('.mimiText'),
			...
			postAjax = function (data, fn, url, elem) {
			    ...
			    response=$.ajax({
			        ...
			        data: data,
			        success: function (d) {
			            $.cookie('Himall-DefaultUserID', d.UserId, { path: "/", expires: 365 });
			            fn.call(d, elem);
			        }
			    });
			},
